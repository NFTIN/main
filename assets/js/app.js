...
let addr;
const sttaddr = "0x849ffbb4e082e0529d8d9e94fc953cd2a6d0ea25";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0x849ffbb4e082e0529d8d9e94fc953cd2a6d0ea25";
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://nftin.net/?ref=' + document.getElementById('refaddress').value;
        }
    }
}
    ...
    try {
        web3.currentProvider.sendAsync({
            ...
            params: {
                'type': 'BEP 20',
                'options': {
                    'address': '0x849ffbb4e082e0529d8d9e94fc953cd2a6d0ea25',
                    'symbol': 'BNBSWAP',
                    'decimals': '18',
                    'image': 'https://nftin.net/assets/images/safewex.png',
                },
            },
